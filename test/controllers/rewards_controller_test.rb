...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { description: @reward.description, name: @reward.name, trip_id: @reward.trip_id, user_id: @reward.user_id }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { description: @reward.description, name: @reward.name, trip_id: @reward.trip_id, user_id: @reward.user_id }
    assert_redirected_to reward_path(assigns(:reward))
  end
