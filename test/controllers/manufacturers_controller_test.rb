...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { description: @manufacturer.description, name: @manufacturer.name, url: @manufacturer.url }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { description: @manufacturer.description, name: @manufacturer.name, url: @manufacturer.url }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
